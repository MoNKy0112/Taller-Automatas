...
public class AFPN {
        ...
        // Metodos
        public AFPN(Alfabeto alfabetoCinta, Alfabeto alfabetoPila, ArrayList<Estado> estados,
        ...
        public void crearTransicion(Estado estadoOrigen, List<Estado> estadosDestino, Character simbL,
                        Character simb1Pila,
                        Character simb2Pila) {
                ...
                HashMap<Character, List<Estado>> transiciones = funcionDeTransicion.getOrDefault(estadoOrigen,
                                new HashMap<>());
                transiciones.put(simbL, estadosDestino);
        ...
        public static void main(String[] args) {
                ...
                AFPN pda = new AFPN(alf, alfp, estados, funcionDeTransicion, funcionDeTransicionPila);
                pda.setEstadoInicial(estados.get(0));
                ArrayList<Estado> estadosAcept = new ArrayList<>();
                estadosAcept.add(estados.get(0));
                pda.setEstadosDeAceptacion(estadosAcept);
                pda.crearTransicion(estados.get(0), estadosAcept, 'a', '$', 'A');
                pda.crearTransicion(estados.get(0), estadosAcept, 'a', 'B', '$');
                pda.crearTransicion(estados.get(0), estadosAcept, 'b', '$', 'B');
                pda.crearTransicion(estados.get(0), estadosAcept, 'b', 'A', '$');

                pda.toStringAFPN();
                // pda.exportar("AFPNVideo");
                // pda.procesarCadenaConDetalles("ab");
                // ArrayList<String> cadenas = new ArrayList<>();
                // cadenas.add("ab");
                // cadenas.add("a");
                // pda.procesarListaCadenas(cadenas, "ListaCadenasAFPNVideo", false);
                // System.out.println(funcionDeTransicion);
                // System.out.println(funcionDeTransicion);
                // System.out.println(afpd.procesarCadenaConDetalles("aaabbb"));
                // pda.exportar("probarAFPD2");
